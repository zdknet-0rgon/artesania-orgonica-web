    ...
    <>
      ...
      <main style={{ padding: '3vw', maxWidth: 900, margin: 'auto', background: 'rgba(255,255,255,0.92)', borderRadius: 18 }}>
        ...
        <section>
          ...
          <p>
            La <b>energía orgónica</b> fue descrita por <b>Wilhelm Reich</b>, científico y psicoanalista, como una fuerza vital fundamental presente en la naturaleza y el organismo humano. El "orgón" es el nombre dado a esta energía sutil, relacionada con salud, equilibrio y procesos naturales como el clima y las emociones humanas. Reich fundó sus estudios en base a observaciones clínicas, experimentos con acumuladores y protocolos que impactaron en la psicoterapia y la biología moderna.
            En el siglo XXI, la energía orgónica ha vuelto a cobrar relevancia por su potencial ecológico, aplicaciones prácticas y por el movimiento de <b>concienciación ambiental</b> nacido en Europa y extendido por todo el mundo.
          </p>
        </section>
        <section>
          <h2>Orgonitas, artesanía y activismo ambiental</h2>
          <p>
            Las <b>orgonitas</b> son artefactos hechos a mano, compuestos de resina, metales y cuarzos, desarrollados desde la década del 2000 para <b>armonizar espacios</b>, mejorar el bienestar energético y apoyar la salud ambiental. Desde nuestro <b>taller artesanal</b> en España hemos impulsado el activismo orgónico y los "gifting" de orgonitas desde 2015, colaborando con redes de ecología y colectivos medioambientales.
            El proceso artesanal respeta la energía, los símbolos y los recursos del entorno, generando piezas únicas y eco-responsables que contribuyen a la protección contra la contaminación electromagnética y el estrés ambiental.
          </p>
        ...
        <section>
          ...
          <p>
            Desde <b>2015</b>, Artesanía Orgónica ha impulsado el activismo orgónico manual en España y otros países, fabricando miles de orgonitas, colaborando con iniciativas ambientales y generando comunidades de conciencia ecológica.
            El <b>gifting</b> orgónico –regalos de orgonitas en lugares estratégicos– forma parte de nuestro compromiso con la regeneración energética de la tierra, la protección de entornos públicos y la educación ambiental profesional.
            Descubre más en nuestro blog donde ciencia, arte y activismo se unen desde la pasión manual y el respeto por la naturaleza.
          </p>
